...
# Modify data types
communitySurvey$StartDate <- as.Date(communitySurvey$StartDate)
communitySurvey$EndDate <- as.Date(communitySurvey$EndDate)
...
communitySurvey$PersonalContinuinty <- ifelse(communitySurvey$Ladder == communitySurvey$LadderFuture, 1 , 0)
```
